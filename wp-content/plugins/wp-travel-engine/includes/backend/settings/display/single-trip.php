...
<div class="wpte-field-subfields<?php echo $related_new_trip_card ? '' : ' hidden'; ?>" data-related-display-new-trip-listing>
	...
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
			...
			<span class="wpte-tooltip"><?php printf( 'Click <a href="%s">here</a> to add difficulty level.', $related_difficulty_tax_url, 'wp-travel-engine' ); ?></span>
		</div>
	</div>
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
			...
			<span class="wpte-tooltip"><?php printf( 'Click <a href="%s">here</a> to add a tag.', $related_tag_tax_url, 'wp-travel-engine' ); ?></span>
		</div>
	</div>
	<div class="wpte-field wpte-floated">
		<div class="wpte-field wpte-checkbox advance-checkbox">
