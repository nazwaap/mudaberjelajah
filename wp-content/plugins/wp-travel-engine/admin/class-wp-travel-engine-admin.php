...
class Wp_Travel_Engine_Admin {
	...
	*/
	public function add_custom_wte_metabox() {
		add_meta_box( 'difficulty_custom_taxonomy_id', 'Difficulty', array(
			$this,
	...
	*/
	...
	public function messages_page() {
		...
		add_submenu_page( 'edit.php?post_type=booking', 'WP Travel Engine Admin Messages', $menu_title, 'manage_options', 'wte-messages', array(
			$this,
	...
	*/
	...
	public function wte_add_dashboard_widget() {
		wp_add_dashboard_widget( 'wpte_dashboard_widget', 'WP Travel Engine Booking Summary', array(
			$this,
