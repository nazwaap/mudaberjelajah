...
**The #1 Travel & Tour Booking WordPress Plugin, Powering Over 10,000 Travel Agency Websites.**
[WP Travel Engine](https://wptravelengine.com/?utm_source=free_plugin&utm_medium=wporg&utm_campaign=upgrade_to_pro) is the best travel booking plugin for travel agencies and tour operators. It empowers you to create beautiful, SEO-friendly websites that showcase your tours and travel packages.
It transforms your basic WordPress website into a full-fledged travel booking platform to increase bookings, inquiries, and Average Order Value (AOV).
...
WP Travel Engine offers a variety of add-ons to expand your website's features and ensure a smooth booking experience for your guests. Explore these features and discover why WP Travel Engine is a leading travel plugin for WordPress.

#### User Experience

* **[Trip Fixed Starting Dates](https://wptravelengine.com/plugins/trip-fixed-starting-dates/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can add departure dates and times to all the tours. In addition, you can create different travel packages (budget, luxury, etc.). Then, the guests can search for the tours according to their travel date plans and book them.
...
* **[Form Editor](https://wptravelengine.com/plugins/form-editor/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can edit and customize the forms to offer a personalized experience.
* **[Email Customizer](https://wptravelengine.com/plugins/email-customizer/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can create customizable and personalized email templates for booking and payment notifications that reflect your brand’s unique identity.
...
#### Marketing
* **[Partial Payment](https://wptravelengine.com/plugins/partial-payment/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can require an upfront payment (percentage or fixed amount) for tours. This allows guests to pay a portion of the total cost upfront while booking and the remaining amount later.
* **[User History](https://wptravelengine.com/plugins/user-history/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — This add-on lets you see what paths your guests take on your website before they book. You'll know which pages they visit and how long they stay on each one.
* **[Trips Embedder](https://wptravelengine.com/plugins/trips-embedder/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — This feature allows you to embed your trips in your website's blog posts and others (such as an influencer or affiliate marketer). By embedding your trip in high-traffic blog posts, you can bring traffic to your trip pages from various sources and increase your bookings.

#### Lead Capture
* **[Itinerary Downloader](https://wptravelengine.com/plugins/itinerary-downloader/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — The add-on automatically creates tour brochures (PDF) that guests can download and read offline. This saves time and money on design costs! Guests can download the brochure by providing an email address (or without).
...
#### Conversion
* **[Legal Documents](https://wptravelengine.com/plugins/legal-documents/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — It allows you to add physical and legal documents to the site. Display them on pages, posts, or widgets using shortcodes for users to view or download.
...
#### WooCommerce Payment
WP Travel Engine integrates seamlessly with WooCommerce, the leading online shop plugin. This means you can accept payments through a wide range of [popular gateways supported by WooCommerce](https://woocommerce.com/product-category/woocommerce-extensions/payment-gateways/), likely including your preferred local option.
...
10. **Unlimited Trip Facts** — You can create unlimited trips ‘Facts’ such as group size, meals, accommodation, the best time to visit and so on, and then add them to different trips.
11. **Destination Page** — Create dedicated pages for popular destinations like London, Nepal, and more. This will allow travelers to easily find trips specific to their dream locations.
12. **Activities Page** — Create dedicated pages for activities like hiking, sightseeing, mountain biking, skiing, and more. This way, travelers can easily find trips that match their interests.
13. **Trip Type Page** — You can categorize the trips according to their types. For example, you can create trip types like child-friendly, budget travel, nature walks and weekend trips.
...
WP Travel Engine helps search engines understand your tours and trips better. It does this using Schema Markup, a special code that makes your website data more organized. This helps people find your tours more easily in search results.
...
**Multilingual**
WP Travel Engine is compatible with WPML and Polylang, the leading multilingual plugins. This lets you create your website in multiple languages, reaching a wider audience of travelers and boosting your competitive edge.

### WP TRAVEL ENGINE SHORTCODES
WP Travel Engine provides various [shortcodes](https://wptravelengine.com/shortcodes/?utm_source=free_plugin&utm_medium=wporg&utm_campaign=documentation) for displaying trips and itineraries, destinations, activities and more.

### GUTENBERG BLOCKS

WP Travel Engine provides 20+ blocks for Gutenberg in the core plugin.

* **Trips** — Display trips according to conditions (featured, latest, on sales and custom selection) and choose from four layouts and other filters.
* **Destinations** — Display Destinations according to many filters and choose from three layouts.
* **Trip Types** — Display Trip Types according to many filters and choose from three layouts.
* **Activities** — Display Activities according to many filters and choose from three layouts.
* **Trip Search** — Display the Search filter horizontally or vertically and add search criteria such as destination, duration, price, activities, etc.
* **Terms** — Display trip categories created under Custom Filters, like Destinations, Activities and Trip Types.

Gutenberg blocks for single trip pages:
* **Trip Booking** — Display essential trip details, including price, discount, highlights and availability button.
* **Trip Duration** — Use the Trip Duration block to show your trip duration.
* **Trip Description** — Enjoy full control over your trip description.
* **Trip Highlights** — Create eye-catching bulleted lists that make your trip highlights stand out.
* **Trip Facts** — Showcase key details like trip type, meals, and transportation in a visually appealing way.
* **Trip Gallery** — Showcase the trip’s best moments in a gallery in just a few clicks.
* **Cost Excludes** — Outline any additional fees or excluded items with eye-catching icons.
* **Cost Includes** — Outline trip inclusions with eye-catching icons.
* **Trip FAQs** — Customize FAQ sections that grab users’ attention, answer questions, and boost your website’s SEO.
* **Trip Itinerary** — Craft a clear itinerary with the Trip Itinerary Block. Add and customize titles, descriptions, icons and dates to timeline items.
* **Trip Map** — Integrate interactive maps with adjustable locations, allowing users to zoom in and out and adjust heights with a few clicks.
* **Trip Enquiry** — Display the trip enquiry form on your website to ensure seamless communication and data collection.
* **WP Travel Engine Tab** — Organize and present your trip information in a structured tabbed format.

The following blocks require premium add-ons of the WP Travel Engine plugin:
* **Trip Itinerary Altitude Chart** — Visually represent trip’s altitude changes throughout the itinerary.
* **Fixed Starting Dates** — Improve trip booking and user navigation with the organized and automated features of the Fixed Starting Dates block.
* **Star Rating** — Display star ratings to establish credibility and build trust with your audience.
* **Trip Ratings** — Display average customer ratings, whether it’s a perfect 5 or a solid 4.
* **Reviews Count** — Showcase the volume of positive reviews you’ve received to increase social proof.
* **Stars Bar Graph** — Transform customer ratings into an easy-to-understand bar graph.
* **Review Form** — Get started quickly with a pre-designed review form to accept review submissions.

### ELEMENTOR WIDGETS

Elementor widgets are essentially the building blocks you use to design your pages. Elementor, a popular page builder plugin, allows you to visually drag and drop these widgets to create your desired layout, eliminating the need to write code.
...
If you cannot find the answer to your questions, we encourage you to contact our support team via [support ticket](https://wptravelengine.com/support-ticket/?utm_source=free_plugin&utm_medium=wporg&utm_campaign=support).
